...
ac = AL.ActiveLearning(train_dataset, 0.99, 2, 30, delta=0.333, debug=False,quiet=True)
ac.test_methods()

train_dataset = torchvision.datasets.MNIST(root='./data', train=True, download=True, transform=transform)
ac = AL.ActiveLearning(train_dataset, 0.99, 2, 30, delta=0.778, debug=False,quiet=True)
ac.test_methods()